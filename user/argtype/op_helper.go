...
const (
	...
	OP_SAVE_PTR_STRING
	OP_READ_STD_STRING
	OP_READ_IL2CPP_STRING
	OP_SAVE_STRING16
	OP_SAVE_PTR_STRING16
)
...
var OPC_FILTER_BUFFER = ROP("FILTER_BUFFER", OP_FILTER_BUFFER)
...
var OPC_READ_IL2CPP_STRING = ROP("READ_IL2CPP_STRING", OP_READ_IL2CPP_STRING)
var OPC_SAVE_STRING16 = ROP("OPC_SAVE_STRING16", OP_SAVE_STRING16)
var OPC_SAVE_PTR_STRING16 = ROP("SAVE_PTR_STRING16", OP_SAVE_PTR_STRING16)
